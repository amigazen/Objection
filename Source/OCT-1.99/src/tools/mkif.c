/*   MKIF.C    Make OOC @interface file                       Oct 89, bjw */

/*
//		03-oct-89	bjw 	Initial coding.
//		12-nov-90	bjw 	use #import for superclass interface file.
*/
...
CONST char		imp_phrase[ ] = { "@implementation" } ;
CONST char		if_phrase[ ]  = { "@interface "     } ;

CONST char		cmt_open[ ]   = { '/', '*', ' ', 0  } ;
CONST char		cmt_close[ ]  = { ' ', '*', '/', 0  };
CONST char	 	dash[ ] 	  = { "-------------------" } ;
