/*   CPPDEF.H    System Defines for CPP program                          */

/* Special macro based debugging package *
 * Fred Fish, 14-Mar-86 */
/* Created SYS_MSDOS for generic system.  SYS_LATTICE is prodcut (bad). *
 * brian witt, 30-may-91. */
 ...
 *  (SYS_LATTICE is Lattice for PC-DOS, SYS_MSDOS is generic.
 *   Lattice also sells an AmigaDOS product.)
 */
...
#if TARGET == SYS_AMIGADOS
#define MACHINE			"amiga", "MCH_AMIGA", "m68000"
...
#endif
#ifdef  u3b15
#define MACHINE 		"u3b15"
#endif
#endif

/*  Generic MS-DOS.   Defines the low-end CPU's only.  Small model.
 *   (added: 30-may-91, brian witt)
 */
#if TARGET == SYS_MSDOS
#define MACHINE			"i8086", "i8088"
#define	SYSTEM			"msdos"
#endif
...

/*
 *  To handle code from the NeXT computer, the #import directive is
 *  needed.  It behaves just like #include, but will only read a file
 *  once.  Much like the GNU cpp "#pragma once <filename>" directive.
 *  Directive not required to recompile 'cpp' itself.
 *  This is non-ANSI, but will most likely be part of the GNU cpp program.
 *  (Oct 90, bjw)
 */

#ifndef SW_IMPORT
#define  SW_IMPORT	TRUE
#endif
